            ...
            <div class="card">
                <div class="card-body">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between" style="margin: -15px 0 -14px 0;">
                        <h4 class="mb-sm-0">LIST OF AESTHETICIANS</h4>
            ...
            <div class="card">
                <div class="card-body" style="height: calc(100vh - 255px); overflow: hidden;">
                    <b-row class="g-2 mb-2">
                        ...
                        <b-col md="2">
                            <Multiselect class="form-control" v-model="filter.specialist" 
                            :close-on-select="true" placeholder="Select Specialist"
                            :searchable="true" :create-option="true" 
                            :options="specialists.data" label="name" track-by="name"/>
                        </b-col>
                        <b-col md="1">
                        ...
                        <table class="table table-nowrap align-middle mb-0">
                            <thead class="table-light">
                                <tr class="fs-11">
                                    ...
                                    <th style="width: 22%;" class="text-center">Specialist</th>
                            ...
                            <tbody>
                                <tr v-for="(list,index) in lists" v-bind:key="index" :class="[(list.is_active == 0) ? 'table-warnings' : '']">
                                    ...
                                    <td>{{list.user.profile.lastname}}, {{list.user.profile.firstname}}</td>
                                    <td class="text-center">{{list.specialist.name}}</td>
